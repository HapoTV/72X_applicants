...
const CocAdminLogin: React.FC = () => {
    ...
    const onSubmit = async (e: React.FormEvent) => {
        e.preventDefault();
        await handleCocAdminLogin(formData);
    };
            ...
            <div className="w-full max-w-lg">
                <div className="text-center mb-8">
                    ...
                    <p className="text-gray-600 -mt-12">
                        Sign in to your COC admin dashboard
                    </p>
                </div>

                <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                    <div className="flex items-center justify-center mb-6">
                        <div className="bg-indigo-100 text-indigo-700 px-4 py-2 rounded-full flex items-center space-x-2">
                            <Shield className="w-4 h-4" />
                            <span className="font-medium">COC Admin Login</span>
                        </div>
                    </div>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    placeholder="Enter your COC admin email"
