...
interface Props {
  ...
  conversationMetaByUserId: Record<
    string,
    { unread: number; lastMessageAt: string; lastMessage: string }
  >;
                ...
                <div className="sm:ml-auto flex items-center gap-2 flex-shrink-0">
                  ...
                  {status === 'PENDING_RECEIVED' && requestId && (
                    <>
                      <div className="relative group">
                        <button
                          ...
                          onClick={
                            isFreeTrialUser
                              ? undefined
                              : () => handleAcceptRequest(requestId, user.userId)
                          }
                      ...
                      <button
                        type="button"
                        onClick={() => handleDeclineRequest(requestId, user.userId)}
                        disabled={isLoading}
